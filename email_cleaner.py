#!/usr/bin/env python3
"""
Email Text Cleaner for NLP Training

This script cleans email content by:
- Removing HTML tags and styling
- Converting links to "link" text
- Removing unnecessary whitespace and formatting
- Normalizing text for better NLP processing
...
def main():
    ...
    if len(sys.argv) != 3:
        ...
        print("\nExample:")
        print("  python email_cleaner.py spam_emails.csv spam_emails_cleaned.csv")
        return
